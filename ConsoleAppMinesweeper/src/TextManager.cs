...
namespace ConsoleAppMinesweeper
{
    ...
    {
        public virtual void PrintWhetherRestartGame()
        {
        ...
        public virtual void PrintGameInstructions()
        {
        ...
        public virtual void ClearUserInputGameInstructions()
        {
        ...
        public void PrintUserDifficultyTitle()
        {
            Console.Clear();
